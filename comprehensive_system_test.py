...
class ComprehensiveSystemTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("ok"):
                    ...
                    details = (
                        f"Bot @{bot_info.get('username')} (ID: {bot_info.get('id')}) is accessible"
                    )
    ...
    def test_menu_dashboard(self):
        ...
        try:
            ...
            if hasattr(bot, "main_menu"):
                self.log_result(
                    "/menu Dashboard", True, "Menu handler exists with dashboard functionality"
                )
            else:
        ...
        try:
            ...
            if log_file.exists():
                ...
                if "✅ Connected to MongoDB" in content:
                    ...
                    self.log_result(
                        "Database Connection", False, "No MongoDB connection found in logs"
                    )
            else:
    ...
    def test_data_persistence(self):
        ...
        try:
            ...
            if database:
                self.log_result(
                    "Data Persistence", True, "Database instance available for persistence"
                )
            else:
        ...
        try:
            ...
            if log_file.exists():
                ...
                if len(warnings) <= 2:  # Allow some warnings
                    self.log_result(
                        "System Logs - Warnings", True, f"{len(warnings)} warnings (acceptable)"
                    )
                else:
        ...
        try:
            ...
            if log_file.exists():
                ...
                if "✅ Connected to MongoDB: otogram" in content:
                    ...
                    self.log_result(
                        "MongoDB Connectivity", False, "MongoDB connection issues found"
                    )
                else:
