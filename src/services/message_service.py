...
class MessageService:
    ...
    async def create_message(self, message_data: MessageCreate) -> Message:
        ...
        await self.collection.insert_one(message.dict())  # type: ignore
    ...
    async def get_message_by_id(self, message_id: str) -> Message | None:
        """Get message by ID"""
        doc = await self.collection.find_one({"id": message_id})  # type: ignore
    ...
    async def update_message(self, message_id: str, update_data: MessageUpdate) -> Message | None:
        ...
        result = await self.collection.update_one({"id": message_id}, {"$set": update_dict})  # type: ignore
    ...
    async def delete_message(self, message_id: str) -> bool:
        """Delete a message"""
        result = await self.collection.delete_one({"id": message_id})  # type: ignore
    ...
    async def increment_usage_count(self, message_id: str) -> None:
        ...
        await self.collection.update_one({"id": message_id}, {"$inc": {"usage_count": 1}})  # type: ignore
