...
class BlacklistHandlers:
    ...
    async def _cleanup_expired(self, update: Update):
        ...
        try:
            ...
            keyboard = [[InlineKeyboardButton("🚫 Lihat Blacklist", callback_data="blacklist_menu")]]
            reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    async def _confirm_remove_blacklist(self, update: Update, blacklist_id: str):
        ...
        try:
            ...
            keyboard = [
                [
                    InlineKeyboardButton("✅ Ya, Hapus", callback_data=f"blacklist_remove_confirm_{blacklist_id}"),
